...
const Header = () => {
  ...
  // Paths for Sign In and Sign Up
  const signInPath =
    menuData.find((item) => item.title === "Sign In")?.path || "/auth/signin";
  const signUpPath =
    menuData.find((item) => item.title === "Sign Up")?.path || "/auth/signup";
  ...
  return (
    ...
    >
      <div className="flex w-full items-center justify-between xl:w-1/4">
        ...
        >
          <span className="relative block h-5.5 w-5.5 cursor-pointer ml-5">
